...
LOG="experiments/logs/lov_color_2d_pose_triangle.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
time ./tools/test_net.py --gpu 0 \
  --network vgg16_convs \
  --model output/lov/lov_train/vgg16_fcn_color_single_frame_2d_pose_triangle_lov_iter_60000.ckpt \
  --imdb lov_keyframe \
  --cfg experiments/cfgs/lov_color_2d_pose.yml \
